...
const Hero = () => {
  return (
    <div className='container mx-auto text-black flex flex-col items-center justify-center mt-40  text-center w-11/12 md:w-4/5'>
        ...
        <p className='text-sm  md:text-2xl  mt-6 md:mt-10 mb-3 md:mb-3 text-center text-gray-700 md:text-gray-500 md:font-primary font-bold md:m-3 md:tracking-wide'>Your personalized trip planner and travel curator, creating ititnereries tailored to your interests and  budgets. Your personalized trip planner and travel curator, creating ititnereries tailored to your interests and  budgets.</p>
        ...
        <img src="/src/assets/Navigate-trip-logo.svg" alt="logo" className='m-30 md:m-40' />
