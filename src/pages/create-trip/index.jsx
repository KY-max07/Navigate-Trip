...
const CreateTrip = () => {
  ...
  return (
    <div className="container mt-15 p-10 md:mx-auto flex flex-col justify-between md:w-3/4 relative ">
          ...
          <div className=" grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-x-20 mt-5   justify-center">
            {SelectTravelList.map((item) => (
              ...
              >
                ...
                <h2 className="font-secondary text-2xl mt-2">
                  {item.title}
                </h2>
                <h2 className="md:font-primary  text-md">
                  {item.desc}
                </h2>
                <h2 className="font-secondary  text-md mt-2">
                  {item.people}
                </h2>
              </div>
            ))}
      ...
      <Button className="mt-10 md:mx-10 mb-2 md:w-30 font-secondary md:flex md:absolute md:right-2 md:bottom-0 " 
      onClick={OnGenerateTrip}
      >
        {loading ? 'Generating...' : 'Generate'}
      </Button>
      </div>
      <Button className="mt-10 md:mx-10 mb-2 md:w-30 font-secondary md:absolute md:right-2 md:bottom-0 md:hidden" 
      onClick={OnGenerateTrip}
      >
